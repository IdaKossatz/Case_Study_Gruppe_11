...
```
komponente_k7 <- read_csv(".\\Data\\Logistikverzug\\Komponente_K7.csv", sep=";")
logistikverzug_k7 <- read_csv(".\\Data\\Logistikverzug\\Logistikverzug_K7.csv", sep=";")
```
...
```
zulassungsdatei <- read.csv(".\\Data\\Zulassungen\\Zulassungen_alle_Fahrzeuge.csv", sep=";")
fahrzeugsdatei <- read.csv(".\\Data\\Fahrzeug\\Bestandteile_Fahrzeuge_OEM2_Typ22.csv", sep=";")
komponentendatei <- read.csv(".\\Data\\Logistikverzug\\Komponente_K7.csv", sep=";")
```
...
```         
daten <- read.csv(".\\Data\\Zulassungen\\Zulassungen_alle_Fahrzeuge.csv", sep=";")
```
...
```
fahrzeug_daten <- read.csv(".\\Data\\Fahrzeug\\Bestandteile_Fahrzeuge_OEM2_Typ22.csv", sep=";")
```

Die Zulassungsdaten werden auch geladen
```
zulassungen_daten <- read.csv(".\\Data\\Zulassungen\\Zulassungen_alle_Fahrzeuge.csv", sep=";")
```
